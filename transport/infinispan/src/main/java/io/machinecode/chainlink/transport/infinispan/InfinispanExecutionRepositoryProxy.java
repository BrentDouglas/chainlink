 ...
 */
public class InfinispanExecutionRepositoryProxy implements ExecutionRepository {

    protected final InfinispanRegistry registry;
    protected final Address address;
    protected final ExecutionRepositoryId executionRepositoryId;

    public InfinispanExecutionRepositoryProxy(final InfinispanRegistry registry, final ExecutionRepositoryId executionRepositoryId, final Address address) {
