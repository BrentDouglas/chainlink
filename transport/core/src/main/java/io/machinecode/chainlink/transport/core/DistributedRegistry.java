 ...
 */
public abstract class DistributedRegistry<A, R extends DistributedRegistry<A, R>> extends LocalRegistry implements DistributedInvoker<A, R> {

    private static final Logger log = Logger.getLogger(DistributedRegistry.class);
    ...
    public DistributedRegistry(final RegistryConfiguration configuration) throws Exception {
