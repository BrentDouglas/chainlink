...
public class GetDeploymentCommand extends BaseCommand {
    ...
    public void exec(final Config config, final AdminCommandContext context) throws Exception {
        ...
        final XmlDeployment that = GlassfishXml.xmlDeployment(requireDeployment(subSystem, deployment));
        context.getActionReport().setMessage(GlassfishXml.writeDeployment(that));
    }
}
