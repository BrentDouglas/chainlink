...
* @since 1.0
*/
public class TestRemoteChain extends DistributedRemoteChain<String> {

    public TestRemoteChain(final Transport<String> transport, final String address, final long jobExecutionId, final ChainId chainId) {
