 ...
 * @since 1.0
 */
public class JmxClientTest extends OperatorTest {
    ...
    public void before() throws Exception {
        ...
        if (this.jmx == null) {
            ...
            this.client = new JmxJobOperatorClient(server, jmx.getName());
    ...
    public void testGetJobInstances() throws Exception {
        final TabularData first = client.getJobInstances("first", 0, 1);
        assertNotNull(first);
        final TabularData second = client.getJobInstances("second", 0, 1);
    ...
    public void testGetParameters() throws Exception {
        final TabularData first = client.getParameters(this.first);
        assertNotNull(first);
        final TabularData second = client.getParameters(this.second);
        assertNotNull(second);
    }

    @Test
    public void testGetJobInstance() throws Exception {
        final CompositeData first = client.getJobInstance(this.first);
        assertNotNull(first);
        final CompositeData second = client.getJobInstance(this.second);
        assertNotNull(second);
    }
    ...
    public void testGetJobExecutions() throws Exception {
        ...
        final TabularData first = client.getJobExecutions(fi.getInstanceId());
        assertNotNull(first);
        final TabularData second = client.getJobExecutions(si.getInstanceId());
        assertNotNull(second);
    }

    @Test
    public void testGetJobExecution() throws Exception {
        final CompositeData first = client.getJobExecution(this.first);
        assertNotNull(first);
        final CompositeData second = client.getJobExecution(this.second);
        assertNotNull(second);
    }

    @Test
    public void testGetStepExecutions() throws Exception {
        final TabularData first = client.getStepExecutions(this.first);
        assertNotNull(first);
        final TabularData second = client.getStepExecutions(this.second);
        assertNotNull(second);
    }

    @Test
    public void testStart() throws Exception {
        final long next = client.start("start", "asdf=asdf");
        assertNotNull(operator.getJobExecution(next));
    }

    @Test
    public void testRestart() throws Exception {
        final long next = client.restart(restart, "asdf=asdf");
        assertNotNull(operator.getJobExecution(next));
    }
