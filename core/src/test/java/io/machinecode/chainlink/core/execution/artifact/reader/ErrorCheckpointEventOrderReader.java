...
import io.machinecode.chainlink.core.execution.artifact.exception.FailReadCheckpointError;
 ...
 * @since 1.0
 */
public class ErrorCheckpointEventOrderReader implements ItemReader {
    ...
    public Serializable checkpointInfo() throws Exception {
        ...
        throw new FailReadCheckpointError();
    }
}
