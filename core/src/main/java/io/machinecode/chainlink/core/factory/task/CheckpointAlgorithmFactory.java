...
public class CheckpointAlgorithmFactory {
    ...
    public static CheckpointAlgorithmImpl produceExecution(final CheckpointAlgorithm that, final JobPropertyContext context) {
    ...
    public static CheckpointAlgorithmImpl producePartitioned(final CheckpointAlgorithmImpl that, final PartitionPropertyContext context) {
