...
public class ReducerFactory {
    ...
    public static ReducerImpl produceExecution(final Reducer that, final JobPropertyContext context) {
    ...
    public static ReducerImpl producePartitioned(final ReducerImpl that, final PartitionPropertyContext context) {
