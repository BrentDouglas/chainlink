...
public class ItemProcessorFactory implements ElementFactory<ItemProcessor, ItemProcessorImpl> {
    ...
    @Override
    public ItemProcessorImpl produceStartTime(final ItemProcessor that, final Properties parameters) {
    ...
    @Override
    public ItemProcessorImpl producePartitionTime(final ItemProcessor that, final JobPropertyContext context) {
