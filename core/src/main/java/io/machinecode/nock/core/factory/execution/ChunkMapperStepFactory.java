 ...
 */
public class ChunkMapperStepFactory implements ExecutionFactory<Step<? extends Chunk, ? extends Mapper>, StepImpl<ChunkImpl, MapperImpl>> {

    public static final ChunkMapperStepFactory INSTANCE = new ChunkMapperStepFactory();

    @Override
    public StepImpl<ChunkImpl, MapperImpl> produceExecution(final Step<? extends Chunk, ? extends Mapper> that, final Execution execution, final JobPropertyContext context) {
        ...
        final ChunkImpl task = that.getTask() == null ? null : ChunkFactory.INSTANCE.produceExecution(that.getTask(), context);
    ...
    @Override
    public StepImpl<ChunkImpl, MapperImpl> producePartitioned(final StepImpl<ChunkImpl, MapperImpl> that, final Execution execution, final PartitionPropertyContext context) {
        ...
        final ChunkImpl task = that.getTask() == null ? null : ChunkFactory.INSTANCE.producePartitioned(that.getTask(), context);
