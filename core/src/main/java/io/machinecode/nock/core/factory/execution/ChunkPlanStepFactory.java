...
public class ChunkPlanStepFactory implements ExecutionFactory<Step<? extends Chunk, ? extends Plan>, StepImpl<ChunkImpl, PlanImpl>> {
    ...
    @Override
    public StepImpl<ChunkImpl, PlanImpl> producePartitioned(final StepImpl<ChunkImpl, PlanImpl> that, final Execution execution, final PartitionPropertyContext context) {
