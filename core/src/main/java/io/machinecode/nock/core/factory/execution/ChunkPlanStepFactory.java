...
public class ChunkPlanStepFactory implements ExecutionFactory<Step<Chunk, Plan>, ChunkPlanStepImpl> {
    ...
    @Override
    public ChunkPlanStepImpl produceStartTime(final Step<Chunk, Plan> that, final Properties parameters) {
    ...
    @Override
    public ChunkPlanStepImpl producePartitionTime(final Step<Chunk, Plan> that, final JobPropertyContext _) {
