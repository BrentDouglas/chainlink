...
public class BatchletPlanStepFactory implements ExecutionFactory<Step<? extends Batchlet, ? extends Plan>, StepImpl<BatchletImpl, PlanImpl>> {
    ...
    @Override
    public StepImpl<BatchletImpl, PlanImpl> producePartitioned(final StepImpl<BatchletImpl, PlanImpl> that, final Execution execution, final PartitionPropertyContext context) {
