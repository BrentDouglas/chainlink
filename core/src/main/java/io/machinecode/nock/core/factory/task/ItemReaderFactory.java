...
public class ItemReaderFactory implements ElementFactory<ItemReader, ItemReaderImpl> {
    ...
    @Override
    public ItemReaderImpl produceStartTime(final ItemReader that, final Properties parameters) {
    ...
    @Override
    public ItemReaderImpl producePartitionTime(final ItemReader that, final JobPropertyContext context) {
