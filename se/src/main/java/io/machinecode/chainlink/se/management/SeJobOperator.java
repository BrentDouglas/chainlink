 ...
 */
public class SeJobOperator implements ExtendedJobOperator {
    ...
    public SeJobOperator() {
        this(Constants.DEFAULT_CONFIGURATION);
    }

    public SeJobOperator(final String id) {
        this(Chainlink.getEnvironment().getJobOperator(id));
    }

    public SeJobOperator(final ExtendedJobOperator delegate) {
