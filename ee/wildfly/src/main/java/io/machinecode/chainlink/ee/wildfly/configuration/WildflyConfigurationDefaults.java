...
import io.machinecode.chainlink.marshalling.jboss.JbossMarshallingProviderFactory;
 ...
 * @since 1.0
 */
public class WildflyConfigurationDefaults implements ConfigurationDefaults {

    private final TransactionManager transactionManager;
    private final BeanManager beanManager;
    private final ClassLoader loader;

    public WildflyConfigurationDefaults(final ClassLoader loader, final BeanManager beanManager, final TransactionManager transactionManager) {
        this.loader = loader;
    ...
    public MarshallingProviderFactory getMarshallerFactory(final Configuration configuration) {
        return new JbossMarshallingProviderFactory();
    }
