...
[source,java]
----
include::{example}/TheArtifactLoader.java[lines=15..-1]
----
...
[source,java]
----
include::{example}/TheJobOperatorConfiguration.java[lines=15..-1]
----

[source,java]
----
include::{example}/TheDeploymentConfiguration.java[lines=15..-1]
----
...
[source,java]
----
include::{example}/TheSubSystemConfiguration.java[lines=15..-1]
----
